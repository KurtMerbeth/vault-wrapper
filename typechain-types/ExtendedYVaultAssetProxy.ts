...
export interface ExtendedYVaultAssetProxyInterface extends utils.Interface {
  functions: {
    "DOMAIN_SEPARATOR()": FunctionFragment;
    "FEE_DOMINATOR()": FunctionFragment;
    ...
    "balanceSnapshots(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "FEE_DOMINATOR",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "balanceSnapshots",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "FeesPaid(address,address,uint256,uint256)": EventFragment;
...
export type FeesPaidEvent = TypedEvent<
  ...
  { user: string; recipient: string; shares: BigNumber; amount: BigNumber }
>;
...
export interface ExtendedYVaultAssetProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExtendedYVaultAssetProxyInterface;
  ...
  functions: {
    ...
    FEE_DOMINATOR(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  balanceSnapshots(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    "FeesPaid(address,address,uint256,uint256)"(
      user?: string | null,
  ...
  populateTransaction: {
    ...
    FEE_DOMINATOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
