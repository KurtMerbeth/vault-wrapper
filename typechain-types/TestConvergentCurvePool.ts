...
export interface TestConvergentCurvePoolInterface extends utils.Interface {
  functions: {
    ...
    "burnLP(uint256,uint256[],address)": FunctionFragment;
    ...
    "setFees(uint120,uint120)": FunctionFragment;
...
export type FeeCollectionEventFilter = TypedEventFilter<FeeCollectionEvent>;
...
export type UIntReturnEventFilter = TypedEventFilter<UIntReturnEvent>;
