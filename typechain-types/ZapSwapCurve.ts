...
export type ZapInInfoStructOutput = [
  string,
  string,
  string,
  BigNumber,
...
export type ZapCurveLpInStruct = {
  curvePool: string;
  lpToken: string;
...
export type ZapCurveLpInStructOutput = [
  string,
  string,
  BigNumber[],
  string[],
...
export type ZapOutInfoStructOutput = [
  string,
  string,
  BigNumber,
  string,
...
export type ZapCurveLpOutStruct = {
  curvePool: string;
  lpToken: string;
...
export type ZapCurveLpOutStructOutput = [
  string,
  string,
  BigNumber,
  string,
